...
export default function CertificateMobileTable({
  certificate,
    ...
    <div>
      <div className="rounded-lg border mt-2 ">
        <UiTable.Table className="">
          ...
          <UiTable.TableBody>
            {certificate?.length === 0 && <UiTable.TableEmpty colSpan={11} />}
            ...
            {certificateData?.map((cet, index) => (
              <UiTable.TableRow key={index} className="">
                ...
                <UiTable.TableCell className="pr-20">
                  <StatusBadge status={cet.certificate_type} />
                </UiTable.TableCell>
                ...
                <UiTable.TableCell className="pr-10 text-gray-500 dark:text-neutral-300 ">
                  {cet.batch_reference}
                </UiTable.TableCell>
          ...
          <UiTable.TableFooter>
            <UiTable.TableRow>
              <UiTable.TableCell colSpan={11} className="text-center">
                <div className="mt-6 ">
                  {/* pagination */}
                  <Paginator
                    items={items ?? 0}
